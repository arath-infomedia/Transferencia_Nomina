...
DIR_HOME=/webapps/ActXLS/WEB-INF #Directorio HOME
...
vsResultado=`java -Xms128m -Xmx1024m  -Duser.timezone=Mexico/General -Dfile.encoding=UTF-8  -Djava.ext.dirs="$DIR_LIB" com.telcel.carga.control.EnvioDatos "$1"`
echo $vsResultado
